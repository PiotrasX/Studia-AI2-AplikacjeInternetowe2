...
- Architektura REST API:  
  - Operacje CRUD (GET, POST, PUT, DELETE).  
  - Zgodność z 2 poziomem modelu dojrzałości Richarsona.  
...
- Logika biznesowa:  
  - Filtrowanie, sortowanie, wyszukiwanie, paginacja.  
...
- Projekt SPA:  
  ...
  - Dynamiczne widoki zależne od roli użytkownika.  
